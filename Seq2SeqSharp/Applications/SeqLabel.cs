    ...
    public class SeqLabel : BaseSeq2SeqFramework<SeqLabelModel>
    {
        ...
        public override List<NetworkResult> RunForwardOnSingleDevice(IComputeGraph g, IPairBatch sntPairBatch, DecodingOptions decodingOptions, bool isTraining)
        {
            ...
            if (isTraining)
            {
                ...
                {
                    cost = g.CrossEntropyLoss(probs, tgtTokensIdxTensor, smooth: m_options.LossSmooth, labelSmooth: m_options.LabelSmooth, graident: LossScaling);
                }
                else
                {
                    ...
                    cost = g.CrossEntropyLoss(probs, tgtTokensIdxTensor, tagWeightsTensor, smooth: m_options.LossSmooth, labelSmooth: m_options.LabelSmooth);
                }
            }
            else
            {
